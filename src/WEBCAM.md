...
# Stock Qidi Plus4  --  TAKEN FROM V2 INSTALLATION GUIDE ON GITHUB  --  OPTION 1  --  WORKED FOR ME
[cam QIDICAM]
mode: ustreamer                         # ustreamer - Provides mjpg and snapshots. (All devices)
...
max_fps: 16                             # If Hardware Supports this it will be forced, otherwise ignored/coerced.

# Stock X3 series, Q1 Pro and (maybe, some) Plus4 series camera  --  OPTION 2  --  DID NOT WORK FOR ME
