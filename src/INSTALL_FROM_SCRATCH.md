...
## 1.) DOWNLOAD BASE IMAGE: [https://github.com/Shadowrom2020/Qidi-X-6-X-7-Armbian/releases](https://github.com/Shadowrom2020/Qidi-X-6-X-7-Armbian/releases)
### TRUNK IMAGES (no 3D printer software installed, just the base Host OS image)
...
### ![_IMAGE__EMMC-AFTER-FLASHING-TRUNK-OS.png](_IMAGE__EMMC-AFTER-FLASHING-TRUNK-OS.png)
